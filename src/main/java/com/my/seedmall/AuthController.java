...
//회원가입
	...
	public String joinEnd(Model m, @ModelAttribute("Member") MemberVO member) {
		...
		member.setPwd(bcyptPasswordEncoder.encode(member.getPwd()));
	...
	public String checkPasswordForModify(Principal pr, Model model) {
...
////로그인
	...
	public String loginProcess(HttpSession session, @ModelAttribute("member") MemberVO member) throws NotUserException {
		...
		memberService.loginCheck(member.getEmail(), member.getPwd());
