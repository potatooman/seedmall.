...
public class BoardNoticeController {
	...
	public String boardNoticeWrite(Model m, Principal pr) {
		MemberVO loginUser = memberMapper.read(pr.getName());
		m.addAttribute(loginUser);
		return "boardNotice/noticewriteForm";
	}
	...
	public String boardNoticeView(Model m, @PathVariable("nidx") int nidx) {
		...
		return "boardNotice/boardNoticeView";
	}// -------------------------------

	@GetMapping("/noticeEdit/{nidx}")
	public String noticeEdit(Model m, Principal pr, @PathVariable("nidx") int nidx) {
		String email=pr.getName();
		log.info(email);
		MemberVO loginUser = memberMapper.read(email);
		log.info(loginUser);
		...
		return "boardNotice/noticeEditForm";
	}// -------------------------------
	...
	public String notiveDelete(Model m, @PathVariable("nidx") int nidx,HttpServletRequest req) {
