...
<div align="center" id="bbs" class="col-md-8 offset-md-2 my-4">
	<h1>리뷰 작성</h1>
	<form name="bf" id="bf" role="form" action="reviewEnd?${_csrf.parameterName}=${_csrf.token}" method="POST" 
		...
		<table class="table">
			...
			<tr>
				...
				<td style="width: 50%" colspan='2'><input type="text" name="email" id="email" class="form-control" readonly value="${loginUser.member.email}"></td>
			</tr>
		...
		<label for="score5"><input type="radio" name="score"  id="score5"value="5">5점</label>
			...
			<tr>
						<td><b>상품이미지</b></td>
							<td style="width: 50%; height: 80px;" colspan='1'><input type="file" name="rimage"
