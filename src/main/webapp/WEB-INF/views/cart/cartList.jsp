					...
					<c:if test="${cartArr ne null and not empty cartArr}">
						<c:forEach var="cart" items="${cartArr}" varStatus="status">
							...
							<tr>
								...
								<td width="15%"><a href="${myctx}/prod/${cart.product.pidx}" target="_blank"> 
								...
								<td><button class="btn btn-outline-danger" type="button" onclick="remove('${cart.cart_idx}')">삭제</button>
							</tr>
