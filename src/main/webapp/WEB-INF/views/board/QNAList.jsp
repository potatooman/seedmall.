...
<table class="table">
 ...
 <c:if test="${qna.secret eq 'N' or loginUser.member.midx eq qna.midx or loginUser.member.auth eq 'ROLE_ADMIN'}">
	 <tr>
	 <td>
	 	...
	 	<td>${qna.email}</td>
	 	<td>${qna.qdate }</td>
	 	<c:if test="${loginUser.member.midx eq qna.midx}">
 ...
 <c:if test="${qna.secret eq 'Y' and loginUser.member.midx ne qna.midx and loginUser.member.auth ne 'ROLE_ADMIN'}">
 	<tr>
