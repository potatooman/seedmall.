...
<body>
	...
	<nav class="py-2 bg-white border-bottom">
		<div class="container d-flex flex-wrap text-end ">
			...
			<ul class="nav">
				<c:if test="${loginUser eq 'anonymousUser'}">
			...
			<c:if test="${loginUser ne 'anonymousUser'}">
				<p style="padding-top: 4px; margin: 0;">${loginUser.member.mname}님</p>
				<div class="flex-shrink-0 dropdown" style="padding-top: 4px;">
					<a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> <%-- <img src="${myctx}/resources/grade_images/${loginUser.member.grade}.jpg" alt="mdo" width="32" height="32" class="" style="margin-top: 3px"> --%>
					</a>
					...
					<ul class="dropdown-menu text-small shadow" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; margin-top: 5px; transform: translate3d(0.5px, 34px, 0px);">
						<c:if test="${loginUser.member.auth == 'ROLE_MEMBER'}">
						...
						<c:if test="${loginUser.member.auth == 'ROLE_ADMIN'}">
						...
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="${myctx}/logout">로그아웃</a>
		...
		<div class="container px-4 px-lg-5 text-start" style="height: 0px;">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="${myctx}/boardNotice/notice">공지사항</a></li>
